...
These guides are task-oriented: they assume you know what you want to do and
show you the shortest path to doing it. Unlike the tutorials, they skip
background explanations.

| Guide | When to use it |
|---|---|
| [Write a Custom Builder](custom-builder.md) | You need a system type not covered by the built-ins |
